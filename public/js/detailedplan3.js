    ...
    $scope.showDailySections = function(){
        ...
        for(var i = 0; i< routeOrigin.daily_sections.length; i++){
            ...
            /*else {
                ...
                //window.bringIt('chosenAccomm'+routeOrigin.daily_sections[i].day_num);
                var accommElem = angular.element(document.querySelector('#chosenAccomm'+$scope.daysNumArr[i]));
        ...
        console.log($scope.dailySections);
        console.log(dailySections);
