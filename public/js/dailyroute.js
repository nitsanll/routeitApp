        ...
        if(chosenRoute != "null"){
            ...
            for(var i = 0; i< chosenRoute.daily_sections.length; i++){
                ...
                if((currentDate.getDate() == tmpDate.getDate()) && (currentDate.getMonth() == tmpDate.getMonth()) 
                    ...
                    htmlContent+='<p class="dailyTripDetail" id="dailyDuration"><span><b> משך המסלול: </b><br>' + duration + ' שעות</span><span id="dailyDiff"> <b> רמת קושי: </b><br>' + diff + '</span></p>'//<button class="endTrip" ng-click="endTrip()"> הפסק טיול </button></p>'
