        ...
        if(chosenRoute != "null"){
            ...
            for(var i = 0; i< chosenRoute.daily_sections.length; i++){
                ...
                if((currentDate.getDate() == tmpDate.getDate()) && (currentDate.getMonth() == tmpDate.getMonth()) 
                    ...
                    htmlContent+='<p class="dailyTripDetail" id="dailyDuration"> <b> משך המסלול: </b><br>' + duration + ' שעות<br><br><b> רמת קושי: </b><br>' + diff +'</p>'//<button class="endTrip" ng-click="endTrip()"> הפסק טיול </button></p>'
