    ...
    $scope.showMyRoutes = function(){
        ...
        if(myRoutesArr == null || myRoutesArr == "[]" || myRoutesArr.length == 0) {
            ...
            for(var i = 0; i<myRoutesArr.length; i++){
                ...
                +'<p class = "tripDetail biggerWidth"> רמת קושי: <br><b class="biggerFont">' + myRoutesArr[i].trip_difficulty + '</b></p><p class = "tripDetail biggerWidth" id="withoutBorder"> מס'+"'"+' ק"מ כולל: <br><b class="biggerFont">' + myRoutesArr[i].trip_km + '</b></p><br></section>';
